...
async def tag_cloud_handler():
    ...
    try:
        ...
        return ft.Div(f"Error loading tag cloud: {str(e)}", class_="error-message")
...
@app.post("/app/notifications/test-email")      # type: ignore
...
@app.put("/app/settings/email")                 # type: ignore
...
@app.post("/app/settings/import")                       # type: ignore
...
async def get_tasks(
    ...
    try:
        ...
        if not tasks:
            return ft.Div(ft.P("No tasks found."))
...
async def get_categories():
    ...
    try:
        ...
        if not categories:
            return ft.Div(ft.P("No categories found."))
...
async def get_tags():
    ...
    try:
        ...
        if not tags:
            return ft.Div(ft.P("No tags found."))
...
async def delete_category(category_id: str):
    ...
    try:
        ...
        return ft.Div()  # Return empty div to replace deleted category
    except Exception as e:
        from app.utils.components import error_message
...
async def delete_tag(tag_id: str):
    ...
    try:
        ...
        return ft.Div()  # Return empty div to replace deleted tag
    except Exception as e:
        from app.utils.components import error_message
